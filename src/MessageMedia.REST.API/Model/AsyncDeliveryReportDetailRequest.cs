...
namespace MessageMedia.REST.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AsyncDeliveryReportDetailRequest :  IEquatable<AsyncDeliveryReportDetailRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncDeliveryReportDetailRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AsyncDeliveryReportDetailRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AsyncDeliveryReportDetailRequest);
        }

        /// <summary>
        /// Returns true if AsyncDeliveryReportDetailRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of AsyncDeliveryReportDetailRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsyncDeliveryReportDetailRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
