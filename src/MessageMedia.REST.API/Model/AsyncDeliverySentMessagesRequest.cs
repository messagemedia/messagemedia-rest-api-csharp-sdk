...
namespace MessageMedia.REST.API.Model
{
    ...
    public partial class AsyncDeliverySentMessagesRequest :  IEquatable<AsyncDeliverySentMessagesRequest>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AsyncDeliverySentMessagesRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AsyncDeliverySentMessagesRequest);
        }

        /// <summary>
        /// Returns true if AsyncDeliverySentMessagesRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of AsyncDeliverySentMessagesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsyncDeliverySentMessagesRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
