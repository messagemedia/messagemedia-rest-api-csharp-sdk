...
namespace MessageMedia.REST.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AsyncReceivedMessagesSummaryRequest :  IEquatable<AsyncReceivedMessagesSummaryRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncReceivedMessagesSummaryRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AsyncReceivedMessagesSummaryRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AsyncReceivedMessagesSummaryRequest);
        }

        /// <summary>
        /// Returns true if AsyncReceivedMessagesSummaryRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of AsyncReceivedMessagesSummaryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsyncReceivedMessagesSummaryRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
