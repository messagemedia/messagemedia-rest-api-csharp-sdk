...
namespace MessageMedia.REST.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AsyncSentMessagesDetailRequest :  IEquatable<AsyncSentMessagesDetailRequest>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AsyncSentMessagesDetailRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AsyncSentMessagesDetailRequest);
        }

        /// <summary>
        /// Returns true if AsyncSentMessagesDetailRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of AsyncSentMessagesDetailRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsyncSentMessagesDetailRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
