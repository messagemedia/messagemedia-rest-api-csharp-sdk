...
namespace MessageMedia.REST.API.Model
{
    ...
    public partial class NewMessage :  IEquatable<NewMessage>
    {
        ...
        public NewMessage(string CallbackUrl = null, string Content = null, string DestinationNumber = null, bool? DeliveryReport = null, FormatEnum? Format = null, DateTime? MessageExpiryTimestamp = null, Object Metadata = null, DateTime? Scheduled = null, string SourceNumber = null, SourceNumberTypeEnum? SourceNumberType = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NewMessage);
        }

        /// <summary>
        /// Returns true if NewMessage instances are equal
        /// </summary>
        /// <param name="other">Instance of NewMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewMessage other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
