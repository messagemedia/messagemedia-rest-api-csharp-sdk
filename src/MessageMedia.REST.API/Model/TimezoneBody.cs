...
namespace MessageMedia.REST.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimezoneBody :  IEquatable<TimezoneBody>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimezoneBody" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TimezoneBody);
        }

        /// <summary>
        /// Returns true if TimezoneBody instances are equal
        /// </summary>
        /// <param name="other">Instance of TimezoneBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimezoneBody other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
